  ...
  return (
    <section className="bg-[#2f2f2f] border border-[#575757] rounded-3xl p-6 md:p-8 space-y-5">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-base text-[#a7a7a7]">연결된 계정222</h2>
        ...
        <button
          ...
          className="inline-flex text-white items-center gap-2 px-3 py-2 rounded-2xl border border-[#45e0c4]/40 hover:border-[#45e0c4] bg-[#353535] hover:bg-[#3b3b3b] transition"
        >
