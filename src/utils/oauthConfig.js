...
export const OAUTH_CONFIG = {
  ...
  kakao: {
    url: 'https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=a04159cc219d093bdcde9d55ea4b88fc&redirect_uri=http://api.lol99.kro.kr/kakao-login',
    logo: kakaoLogo,
    color: 'bg-gray-900 hover:bg-[#FEE500]',
  },
};
