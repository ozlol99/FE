...
export const OAUTH_CONFIG = {
  google: {
    url: 'https://accounts.google.com/o/oauth2/v2/auth?response_type=code&scope=openid%20email&client_id=281980891262-7nagpvldql6sg5ejlvsecps9gvlsdcqj.apps.googleusercontent.com&redirect_uri=https://api.lol99.kro.kr/google-login',
    logo: googleLogo,
    color: 'bg-gray-900 hover:bg-black',
  },
  kakao: {
